...
def capital_gains_tax_page():
    ...
    faq = [
        ...
        ("다주택 중과는 지금 적용되나요?", ["조정대상지역에서 2주택자는 기본세율에 20%p, 3주택 이상은 30%p를 더하고 장기보유특별공제를 배제하는 제도입니다. 2022년 5월부터 한시적으로 배제(유예)되어 왔고, 유예 기한이 해마다 연장되어 왔습니다.", "이 계산기는 마지막으로 확인된 유예 종료일을 상수로 두고 양도일에 따라 스위치 기본값을 정합니다. 양도일이 그 날짜 이후면 연장 여부를 확인하라는 경고를 띄웁니다. 스위치를 직접 바꿔 두 경우를 모두 볼 수 있습니다."]),
        ...
        <section class="card">
          ...
          <div class="table-wrap" style="margin-top:10px"><table class="tbl ref-table nowrap-head">
            ...
            <tbody>
              ...
              <tr><th scope="row">조정지역 2주택 / 3주택↑ 중과</th><td>+20%p / +30%p (유예 시 미적용)</td></tr>
